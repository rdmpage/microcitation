...
//$sql = 'SELECT * FROM publications WHERE issn="' . $issn . '" AND volume IN (68, 69,70,71)';

$sql = 'SELECT * FROM publications WHERE guid="10.7525/j.issn.1673-5102.2006.01.018"';


$sql = 'SELECT * FROM publications 
INNER JOIN multilingual USING(guid)
WHERE guid="10.7525/j.issn.1673-5102.2006.01.018"';
